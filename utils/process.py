...
class Process():
    ...
    def exec(self, path):
        ...
        print(f"Total de memória virtual utilizada pelo processo: {total_virtual_memory_usage} MB")
        print(f"Quantidade de tempo gasto em modo usuário: {times.user} s")
        print(f"Quantidade de tempo gasto em modo núcleo: {times.system} s")